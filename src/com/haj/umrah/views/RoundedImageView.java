...
public class RoundedImageView extends ImageView
{
    ...
    public RoundedImageView(Context context, int drawableResId, ImageView.ScaleType scaleType, int cornerRadius,int borderWidth, int borderColorStateList,boolean roundBackgroud, boolean isOval)
    {
	super(context);
	Log.d(TAG, "**********************-111");
	...
	init(drawableResId,scaleType, cornerRadius, borderWidth, borderColorStateList, roundBackgroud, isOval);
    }
    ...
    /** If the view is created dynamically in java and not in xml then this method will be called from constructor RoundedImageView(Context context, int iconResId, String title). **/
    private void init(int drawableResId,ImageView.ScaleType scaleType, int cornerRadius,int borderWidth, int borderColorStateList,boolean roundBackgroud, boolean isOval){
	...
	mBorderColor = getResources().getColorStateList(borderColorStateList);
	if (mBorderColor == null)
	{
	    mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
	}

	mRoundBackground = roundBackgroud;
	mOval = isOval;
