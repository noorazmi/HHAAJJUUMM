...
//	}
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			imageView = (ImageView) v.findViewById(R.id.posted_image);
			...
			mImageFetcher.loadImage(Images.imageUrls[position], imageView);
			return v;
		}
		...
		// LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, mItemHeight);
	...
	protected void initFields(Bundle bundle) {
		...
		final ListView mGridView = (ListView) getFragmentView().findViewById(R.id.gridView);
