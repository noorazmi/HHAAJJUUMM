...
public class Crypt {
    ...
    public static SecretKey deriveKeyPbkdf2(byte[] salt,
            String password) {
        try {
    ...
    public static String decryptPbkdf2(String ciphertext,
            String password) {
    ...
    public static String decryptNoSalt(String ciphertext,
            SecretKey key) {
        String[] fields = ciphertext.split(DELIMITER);
        if (fields.length != 2) {
            throw new IllegalArgumentException("Invalid encypted text format");
