...
public interface ConstantValues {
    ...
    String CARDIO_APP_TOKEN = "7e316f00cbfe4b4faf914573800dc433";
    ...
    // Royalty points
    public static final String KOHLS_CHARGE_SIGN_IN_URL = "https://credit.kohls.com/eCustService/#";

    // public static final String URL_ROYALTY =
    // "https://kwallet.skavaone.com/wallet/v1/loyalty/profiles?channel=D";
    public static final String KOHLS_CHARGE_APPLY_NOW_URL = "https://apply.kohls.com/kohp_zb/app";

    public static final String CUSTOMER_SERVICE_URL = "https://cs.kohls.com/";

    public static final String PRIVACY_POLILCY_URL = "http://d16rliti0tklvn.cloudfront.net/3/1402000336668.1119292523.html";

    public static final String CALIFORNIA_PRIVACY_POLILCY_URL = "http://d16rliti0tklvn.cloudfront.net/3/1402000336668.1119292523.html#calirights";

    public static final String LEGAL_NOTICES_URL = "http://www.kohls.com/catalog/common/content.jsp?pageName=legalnotices";

    public static final String CONTACT_US_EMAIL_URL = "https://cs.kohls.com/app/ask/noIntercept/1";

    // public static final String HELP_CONTACT_US_EMS_URL =
    // "http://kohlsdev.km.sl.edst.ibm.com/kohls/invoke?adapter=CmsAdapter&procedure=getMultiplePageByName&parameters=['%7B%22pageType%22:%22homePage%22%7D']";
    public static final String HELP_CONTACT_US_CMS_URL = "http://mobileapp.kohls.com/skavastream/studio/v2/skava/getMultiplePageByName/181/dev/phone?pageName=helpcontactus&pageName=loyaltyhelp";
    ...
    // public static final String URL_ROYALTY =
    // "https://kwallet.skavaone.com/wallet/v1/loyalty/profiles?channel=D";
    public static final String URL_ROYALTY = "https://kloyalty.skavaone.com/wallet/v1/loyalty/profiles?channel=D";

    public static final String LIST_URL = "http://kstage1.skavaone.com/kohlswishlist/indexandroid.html";

    // Get Registry Domain

    public static final String REGISTRY_URL = "http://kstage1.skavaone.com/nativeregistry/index.html";
    ...
    public static final String DOMAIN_NAME = "kstage1.skavaone.com";
    ...
    public static final String JSON_TYPE_REGISTRY_SEARCH = "http://kstage1.skavaone.com/nativeregistry/search.html";
    ...
    String URL_CATALOG = "/catalog?channel=mobile";

    String URL_CATEGORY = "/catalog/category?channel=mobile";

    String URL_CATEGORY_BY_ID = "/catalog/category/{categoryID}?channel=mobile";
    ...
    // time when secure screen will be killed

    String STORE_SHOP_LOCAL_URL = "http://api.shoplocal.com/kohls/2010.3/XML/getstores.aspx";
    ...
    public static final String SCAN_PDP = "SCAN_PDP";
    ...
    public static final String SIZE_AND_FIT_GUIDE = "http://www.kohls.com/media/digital/ecom/size-charts/womens/Womens236_MD.htm";
    ...
    String PDP_OFFER_ENABLE_BUTTONS = "enableButtons";
    ...
    String ORDER_CAL_ERROR_CODE = "ORDER4000";
    ...
    // This url will be used when royalty id is already available and user want
    // to register with that loyalty id.
    public static final String URL_ROYALTY_APPEND = "https://kwalletstage.skavaone.com/wallet/v1/loyalty/profiles/";
