...
import com.jeremyfeinstein.slidingmenu.lib.app.SlidingMenu.OnClosedListener;
import com.jeremyfeinstein.slidingmenu.lib.app.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (thisTouchAllowed(ev)) {
                    ...
                    if (isMenuOpen() && mViewBehind.menuTouchInQuickReturn(mContent,
                            mCurItem,
                            ev.getX() + mScrollX)) {
                        mQuickReturn = true;
                    }
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged) {
                    ...
                    mActivePointerId = INVALID_POINTER;
                    endDrag();
                } else if (mQuickReturn && mViewBehind.menuTouchInQuickReturn(mContent,
                        mCurItem,
                        ev.getX() + mScrollX)) {
                    // close the menu
                    setCurrentItem(1);
    ...
    private int determineTargetPage(float pageOffset,
            int velocity,
            int deltaX) {
